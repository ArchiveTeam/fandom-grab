...
LUA_SHA1 = get_hash(os.path.join(CWD, 'fandom.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type == 'page':
                ...
                wget_args.append('https://'+item_wiki+'.fandom.com/api.php?action=query&pageids='+item_value+'&format=json')
            elif item_type == 'f':
...
project = Project(
    title='Fandom',
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/thumb/0/00/Fandom-logo.png/800px-Fandom-logo.png" height="50px" title=""/>
        <h2>fandom.com <span class="links"><a href="https://fandom.com/">Website</a> &middot; <a href="http://tracker.archiveteam.org/fandom/">Leaderboard</a></span></h2>
        <p>Archiving everything from Fandom.</p>
    '''
)
